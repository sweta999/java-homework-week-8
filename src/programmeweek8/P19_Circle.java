...
public class P19_Circle {
    //Instance Variable
    double radius;

    //Constructor with 1 double type parameter and initialising the fields.
    public P19_Circle(double radius) {
        //this.radius = radius;
    ...
    public double getArea() {
        double area;
        area = radius * radius * Math.PI;   // For PI, Math.PI constant is used.
        return area;
    }
